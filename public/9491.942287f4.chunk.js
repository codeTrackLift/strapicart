...
`])),function(v){return v.theme.colors.neutral800},function(v){return v.theme.colors.neutral600},function(v){var _=v.theme;return`
      background-color: `.concat(_.colors.primary100,`;
      border-right: 2px solid `).concat(_.colors.primary600,`;
      svg > * {
        fill: `).concat(_.colors.primary700,`;
      }
      `).concat(b.Typography,` {
        color: `).concat(_.colors.primary700,`;
        font-weight: 500;
      }
      `)}),be=n()($.a)(N||(N=g()([`
  width: `,`rem;
...
`])),2,.25,function(v){return v.theme.colors.neutral500}),Ue=n()(Ne.Badge)(We||(We=g()([`
  display: flex;
  align-items: center;
`]))),Be=function(v){var _=v.collapsable,G=v.label,K=v.badgeLabel,re=v.children,ue=v.id,de=Object(h.useState)(!0),xe=w()(de,2),fe=xe[0],pe=xe[1],ye=Object(H.a)("subnav-list",ue);return s.a.createElement(k.Box,null,s.a.createElement(qe,{paddingLeft:6,paddingTop:2,paddingBottom:2,paddingRight:4},s.a.createElement(x.Flex,{justifyContent:"space-between"},s.a.createElement(Re,{onClick:function(){pe(function(Oe){return!Oe})},ariaExpanded:fe,ariaControls:ye,collapsable:_,label:G}),K&&s.a.createElement(Ue,{backgroundColor:"neutral150",textColor:"neutral600"},K))),(!_||fe)&&s.a.createElement("ul",{id:ye},h.Children.map(re,function(Oe,he){return s.a.createElement("li",{key:he},Oe)})))};Be.defaultProps={badgeLabel:null,collapsable:!1,id:void 0},Be.propTypes={badgeLabel:u.a.string,children:u.a.node,collapsable:u.a.bool,id:u.a.string,label:u.a.string.isRequired};var Ge=e(23),Ye=["children"],_e=function(v){var _=v.children,G=t()(v,Ye);return s.a.createElement(k.Box,{paddingTop:2,paddingBottom:4},s.a.createElement(Ge.Stack,d()({as:"ul",spacing:2},G),h.Children.map(_,function(K,re){return s.a.createElement("li",{key:re},K)})))};_e.propTypes={children:u.a.node.isRequired}}])})},33109:function(we,Ae,X){(function(Ce,oe){we.exports=oe(X(53547))})(this,function(Ce){return function(oe){var J={};function D(R){if(J[R])return J[R].exports;var I=J[R]={i:R,l:!1,exports:{}};return oe[R].call(I.exports,I,I.exports,D),I.l=!0,I.exports}return D.m=oe,D.c=J,D.d=function(R,I,V){D.o(R,I)||Object.defineProperty(R,I,{enumerable:!0,get:V})},D.r=function(R){typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(R,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(R,"__esModule",{value:!0})},D.t=function(R,I){if(1&I&&(R=D(R)),8&I||4&I&&typeof R=="object"&&R&&R.__esModule)return R;var V=Object.create(null);if(D.r(V),Object.defineProperty(V,"default",{enumerable:!0,value:R}),2&I&&typeof R!="string")for(var ie in R)D.d(V,ie,function(ce){return R[ce]}.bind(null,ie));return V},D.n=function(R){var I=R&&R.__esModule?function(){return R.default}:function(){return R};return D.d(I,"a",I),I},D.o=function(R,I){return Object.prototype.hasOwnProperty.call(R,I)},D.p="",D(D.s=53)}({0:function(oe,J){oe.exports=Ce},53:function(oe,J,D){"use strict";D.r(J);var R=D(0);function I(){return(I=Object.assign||function(V){for(var ie=1;ie<arguments.length;ie++){var ce=arguments[ie];for(var a in ce)Object.prototype.hasOwnProperty.call(ce,a)&&(V[a]=ce[a])}return V}).apply(this,arguments)}J.default=function(V){return R.createElement("svg",I({width:"1em",height:"1em",viewBox:"0 0 4 4",fill:"none",xmlns:"http://www.w3.org/2000/svg"},V),R.createElement("rect",{width:4,height:4,rx:2,fill:"#A5A5BA"}))}}})})}}]);
